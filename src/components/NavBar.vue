  ...
  <nav class="honeydew-header">
    ...
    <div class="honeydew-auth">
      <div v-if="store.userAuthInfo" class="honeydew-auth success">
        <a
          @click.prevent="actionsOpened = !actionsOpened"
          class="honeydew-auth_user"
        >
          <span class="honeydew-auth_name">{{
            store.userAuthInfo.given_name
          }}</span>
          <span
            class="honeydew-auth_avatar"
            v-html="store.userAuthInfo.avatar"
          ></span>
        </a>
